$(document).ready(function () {
    ...
    var actionPanelInitOffset = $('.actionPanel').offset().top;

    $('#content').scroll(function (e) {
        var topOffset = $(this).scrollTop();

        var actionPanelOffset = actionPanelInitOffset + topOffset;

        $('.actionPanel').offset({ top: actionPanelOffset });
    })
        ...
        *******************************************************/
        ...
        if ($('#kitchenOverviewPage').length > 0) {
            ...
            io.socket.on('newOrderAdded', function (result) {
                ...
                var appElement = document.querySelector('#kitchenOverviewPage');
